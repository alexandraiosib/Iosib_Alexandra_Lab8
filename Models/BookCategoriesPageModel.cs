...
namespace Iosib_Alexandra_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Iosib_Alexandra_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Iosib_Alexandra_Lab8Context context,
